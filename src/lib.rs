...
//! ```
//! // Decode the map
//! let map = mames_pp::Beatmap::from_path("./resources/2785319.osu").unwrap();
//!
//! // Calculate difficulty attributes
//! let diff_attrs = mames_pp::Difficulty::new()
//!     .mods(8 + 16) // HDHR
//!     .calculate(&map);
//!
...
//! let perf_attrs = mames_pp::Performance::new(diff_attrs)
...
//!
//! ```
//! use mames_pp::{Beatmap, GradualPerformance, Difficulty, any::ScoreState};
//!
